...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href='{{ backpack_url('blacklist-pass-holder') }}'><i class='fa fa-exclamation-circle'></i> <span>De-Listed Pass Holders</span></a></li>
...
@if(auth()->user()->hasAnyRole(config('backpack.company.roles')))
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href='{{ backpack_url('tenant-blacklist-pass-holder') }}'><i class='fa fa-exclamation-circle'></i> <span>De-Listed Pass Holders</span></a></li>
