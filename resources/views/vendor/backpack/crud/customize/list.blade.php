...
@section('header')
	<section class="content-header">
      ...
      <small id="datatable_info_stack" class="content_title_header">{!! $crud->getSubheading() ?? trans('backpack::crud.all').'<span>'.$crud->entity_name_plural.'</span> '.trans('backpack::crud.in_the_database') !!}.</small>
	  </h1>
	  <!-- <ol class="breadcrumb">
