...
<div class="modal modal-primary fade" id="modal-pass-holder" style="bottom: 40px; display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{ route('admin.tenant-pass-holder.import') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <p>Note: 
                        <ul>
                            ...
                            <li>
                                Demo file: <a href="{{ route('admin.tenant-pass-holder.import.demo') }}" class="btn btn-xs btn-warning">download demo</a>
                            </li>
                        </ul>
                    </p>
                </div>
