...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            [
                'data' => ['id' => 1, 'name' => 'Manager (A) Aviation Security', 'email' => 'test1@gmail.com', 'password' => bcrypt('123456'), 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
                'role' => ['role_id' => CAG_ADMIN_ROLE_ID, 'model_type' => 'App\Models\BackpackUser', 'model_id' => 1]
            ],
            [
                'data' => ['id' => 2, 'name' => 'Manager (B) Aviation Security', 'email' => 'test2@gmail.com', 'password' => bcrypt('123456'), 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
                'role' => ['role_id' => CAG_ADMIN_ROLE_ID, 'model_type' => 'App\Models\BackpackUser', 'model_id' => 2]
            ],
            [
                'data' => ['id' => 3, 'name' => 'OC Airport Pass Office', 'email' => 'test3@gmail.com', 'password' => bcrypt('123456'), 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
                'role' => ['role_id' => CAG_ADMIN_ROLE_ID, 'model_type' => 'App\Models\BackpackUser', 'model_id' => 3]
            ],
            [
                'data' => ['id' => 4, 'name' => 'Deputy OC Pass Office', 'email' => 'test4@gmail.com', 'password' => bcrypt('123456'), 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
